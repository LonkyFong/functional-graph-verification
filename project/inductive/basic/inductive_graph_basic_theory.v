...
Lemma updateEntry_does_not_change_key_set : forall (node : Node) (f : NatSet.t * NatSet.t -> NatSet.t * NatSet.t) (ig : IG) (x : Node),
  In x (labNodes (updateEntry node f ig)) <-> In x (labNodes ig).
Proof.
